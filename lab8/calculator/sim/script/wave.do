...
add wave -noupdate /seven_seg_tb/uut/top_fsm/CurrentState
...
add wave -noupdate -radix unsigned /seven_seg_tb/uut/rom_addr
add wave -noupdate /seven_seg_tb/uut/op
add wave -noupdate -radix unsigned /seven_seg_tb/uut/result
add wave -noupdate /seven_seg_tb/uut/ram_addr
...
add wave -noupdate /seven_seg_tb/uut/top_fsm/rom_data
add wave -noupdate /seven_seg_tb/uut/rom_inst/address
add wave -noupdate /seven_seg_tb/uut/rom_inst/q
add wave -noupdate /seven_seg_tb/uut/rom_inst/sub_wire0
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {375652 ps} 0}
